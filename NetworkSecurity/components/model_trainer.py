...
class ModelTrainer:
    ...
    ## Perform Hpyerparameter Tunning

        params = {
            "Decision Tree" : {
                "criterion" : ['gini', 'entropy', 'log_loss'],
                # "splitter" : ['best','random'],
                # "max_feature" : ['sqrt','logs']
            },
            
            "Random Forest" : {
                # "criterion" : ['gini', 'entropy', 'log_loss'],
                # "max_feature" : ['sqrt', 'logs', None],
        ...
        classification_test_metric = get_classification_score(y_true=y_train, y_pred=y_test_pred)
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            ## Loading training array and feeding test array
