...
class TrainingPipeline:
    ...
    def sync_saved_model_dir_to_s3(self):
        try:
            ...
            self.s3_sync.sync_folder_from_s3(folder = self.training_pipeline_config.model_dir,aws_bucket_url=aws_bucket_url)
        except Exception as e: 
            raise NetworkSecurityException(e,sys)
    ...
    def run_pipeline(self):
        try:
            ...
            model_tainer_artifact = self.start_model_trainer(data_transformation_artifact=data_transformation_artifact)
